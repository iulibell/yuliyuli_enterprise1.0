...
public class UserWrapper {
  ...
  /**
   * 根据用户ID构造用户详情更新条件 核心修复：更新操作返回LambdaUpdateWrapper，而非查询包装器
   *
   * @param userId 用户ID
   * @return LambdaUpdateWrapper<UserInfo> 更新条件
   */
  public LambdaUpdateWrapper<UserInfo> buildUpdateUserInfoByUserId(
      Long userId, short gender, Date birthday, String sign) {
